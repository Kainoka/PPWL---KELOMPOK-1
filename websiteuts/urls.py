...
# ini untuk menampilkan gambar yg sudah di upload pada folder media
from django.conf import settings
from django.conf.urls.static import static

from websiteuts.views import home, about, contact, detail_artikel
from websiteuts.authentikasi import akun_login, akun_registrasi, akun_logout
