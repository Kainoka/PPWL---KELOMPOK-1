...
class Artikel(models.Model):
  ...
  thumbnaill = models.ImageField(upload_to='artikel', blank=True, null=True)
  ...
  #       if not self.slug:
  #           date_part = self.created_at.strftime('%Y-%m-%d')  # Format tahun/bulan/tanggal
  #           self.slug = slugify(f"{date_part}-{self.judul}")
